# Agent instructions for PokemonHelp

Use this file to steer how the AI agent behaves when working on this project.
...
- Prefer clear names and small, focused modules over large monoliths.
- Put effort in all graphics and make them look amazing.
